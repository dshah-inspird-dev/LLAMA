...
def main(args):
  ...
  if str(args.vocab_path).endswith('.txt'):
      print("here")
      tokenizer = tokenizers['word_piece'](args.vocab_path)
  else:
...
def build_argument_parser():
  ...
  parser.add_argument('--model_config',
            default='/home/dshah/nlp/DeBerta/DeBERTa/experiments/language_model/deberta_base.json',
            type=str,
